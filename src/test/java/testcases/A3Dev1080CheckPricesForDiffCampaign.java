...
@Test(groups = {"CheckPriceMB"}, dependsOnGroups="CheckPriceAD2", alwaysRun = true)
@Listeners(TestFailureListener.class)
public class A3Dev1080CheckPricesForDiffCampaign {	
	  String media = Helper.BuyNow;
	  String format = "CD101V";
	  String product = "CD101V - Cover 2";
	  String theDay = Helper.noTuesday;
			 ...
			 @DataProvider
			  public Object[][] inputData() {
			   ...
			   //publisher,campaign,rateCardPrice,buyNowPrice,crossPrice,contractDeductedPrice,volumeDedactedPrice,contract,volume,surchargePrice,finalPrice 
	       		{Helper.UG,"1","6.300,00","3.150,00","3.150,00","1.575,00","0,00","50,00","0,00","0,00","1.575,00"},
				{Helper.UG,"2","6.300,00","3.150,00","6.300,00","3.150,00","0,00","50,00","0,00","0,00","3.150,00"},
			    {Helper.Res,"1","5.000,00","5.500,00","5.500,00","2.750,00","687,50","50,00","25,00","0,00","2.062,50"},
			    {Helper.Res,"2","5.000,00","5.500,00","5.000,00","2.500,00","625,00","50,00","25,00","0,00","1.875,00"},
			    };
			  }
